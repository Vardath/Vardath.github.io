...
(()=>{
  ...
  if(top&&!document.getElementById('vardath-site-nav')){
    ...
    nav.innerHTML='<a href="index.html">Home</a><a href="vardath-cosmology.html">Cosmology</a><a href="phonetic-bridge.html">Phonetic Bridge</a><a href="art.html">Art Archive</a><a href="wng-art.html">WNG Art Gallery</a>';
    top.appendChild(nav);
  }
