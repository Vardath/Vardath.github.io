...
Air is harder to notice until it changes.

That makes atmosphere one of the strangest cargos in Vardath Cosmology.
...
I do not think of air as an empty region sitting above the real world.
...
The first contact between those environments may be atmospheric before it is geological.

Gas finds openings quickly.

## Pressure difference drives motion

A pressure difference stores potential for flow.

Open a route and the gas moves.

That is simple enough at small scale.

At world scale it becomes violent.

If the present and next turns do not have the same pressure conditions, then a gate creates wind by definition.

The greater the difference, the stronger the flow.

This gives storm imagery a natural place in the model.

Wind is not just weather accompanying the event.

It can be direct evidence, within the cosmology, that two previously separated atmospheric systems have become connected.

## The first breath of the gate

This is one reason breath, wind and spirit imagery interests me so much.

Human cultures naturally connect breath with life.

The world “breathing” is already an intuitive image.
...
That does not mean ancient spirit concepts were secret pressure diagrams.
...
Mist is almost perfect gate imagery.

It hides ordinary landmarks.

It destroys distance cues.

It changes sound.

It makes nearby things appear and disappear.

A traveller entering dense mist can lose normal orientation without moving far at all.

Add changed adjacency to that environment and the result would be almost impossible to describe afterward in ordinary geographic language.

This is why fairy roads so often begin in fog or strange weather in my reading.

The mist does not have to create the gate.

It can be the atmospheric skin of the gate.

## Heat

Heat is unavoidable once the current concentrates.
...
The melting is not only about stone.

It is about the environment surrounding the stone.

## Meltology as environmental state

I do not think Meltology should be treated as one strange isolated claim that a building “looks melted.”

Inside Vardath Cosmology it is a branch of the waking-world environment.
...
This is one of the most important combinations in the model.

Modern imagination often separates flood and fire into different apocalypse types.
...
A god who arrives in thunder does not have to be reduced to “just weather.”

In my model, thunder can be one sensory aspect of a much larger boundary event.

The world is loud because the environment itself is changing.

## Darkness and brilliance

The active atmosphere can also explain why stories alternate between darkness and impossible brightness.

Dense cloud, dust, ash, vapour and steam can block ordinary light.

Electrical discharge and luminous plasma-like effects can produce intense local brilliance.

A bright node seen through dark cloud can appear as an eye or star.

A luminous rod can appear inside a blackened sky.

The same event can therefore generate darkness and radiance together.

That is a very mythic-looking world.

It does not need to be supernatural in my model.

It needs an atmosphere in transition.
...
The successor environment cannot begin with rock and water alone.

It needs enough atmosphere to support weather and life.
...
That makes the reset much more complete.

## The sky remembers the pressure

Cloud patterns, winds, storms and visibility all depend on pressure structure.

That means the sky becomes a visible map of the atmospheric side of the event.

The quiet sky looks one way because the atmosphere is in one stable regime.

The waking sky looks another way because the boundary relation has changed.

The sky does not merely “announce” the event symbolically.

It physically participates.

That is why I keep saying the sky is part of the machine.
...
Water leaves shorelines.

Sediment leaves layers.

Heat leaves altered material.

Air leaves less obvious traces.

That makes atmospheric inheritance easy to overlook.
...
It transfers the conditions of life.

The next chapter moves to the heaviest cargo:

stone, crust and sediment.
